...
namespace MVCProject.Controllers
{
    public class AgentController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AgentInfo([Bind(Include = "Username,Email,Fax,Address,Phone,UserType,DateCreate,Expire,LocationID,LocationSubID,District,State,TaxID,DisplayName,UserOfName,UserOfType,IsDel,IsActive")] 
